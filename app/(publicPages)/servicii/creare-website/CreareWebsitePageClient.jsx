...
export default function CreareWebsitePageClient() {
        ...
        <div className="min-h-screen">
            ...
            <section className="pt-32 pb-20 px-6 md:px-16 lg:px-24 xl:px-32 bg-gradient-to-b from-slate-50 to-white">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6">
                        {t("createWebsitePage.title")}
                    </h1>
                    <p className="text-xl text-slate-600 mb-8 max-w-2xl mx-auto">
                        {t("createWebsitePage.subtitle")}
                    </p>
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <Link href="/contact" className="bg-black hover:bg-gray-800 transition text-white rounded-md px-8 h-12 font-medium flex items-center">
                            {t("createWebsitePage.requestOffer")}
                        </Link>
                        <Link href="/#servicii" className="border border-black transition text-slate-600 rounded-md px-8 h-12 font-medium flex items-center">
                            {t("createWebsitePage.seeAllServices")}
                        </Link>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 px-6 md:px-16 lg:px-24 xl:px-32">
                <div className="max-w-3xl mx-auto">
                    <p className="text-lg text-slate-600 leading-relaxed text-center">
                        {t("createWebsitePage.description")}
                    </p>
                </div>
            </section>
            ...
            <section className="py-16 px-6 md:px-16 lg:px-24 xl:px-32 bg-slate-50">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl font-bold text-slate-900 mb-10 text-center">{t("createWebsitePage.whatsIncluded")}</h2>
                    <div className="grid md:grid-cols-2 gap-4">
                        {(t("createWebsitePage.includes") || []).map((item, index) => (
            ...
            <section className="py-16 px-6 md:px-16 lg:px-24 xl:px-32">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl font-bold text-slate-900 mb-10 text-center">{t("createWebsitePage.processTitle")}</h2>
                    <div className="space-y-6">
                        {(t("createWebsitePage.process") || []).map((item, index) => (
            ...
            <section className="py-16 px-6 md:px-16 lg:px-24 xl:px-32 bg-slate-900 text-white">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl font-bold mb-10 text-center">{t("createWebsitePage.benefitsTitle")}</h2>
                    <div className="grid md:grid-cols-2 gap-6">
                        {(t("createWebsitePage.benefits") || []).map((benefit, index) => (
            ...
            <section className="py-16 px-6 md:px-16 lg:px-24 xl:px-32">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl font-bold text-slate-900 mb-10 text-center">{t("createWebsitePage.targetTitle")}</h2>
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {(t("createWebsitePage.targetAudience") || []).map((audience, index) => (
            ...
            <section className="py-16 px-6 md:px-16 lg:px-24 xl:px-32 bg-slate-50">
                <div className="max-w-3xl mx-auto">
                    <h2 className="text-3xl font-bold text-slate-900 mb-10 text-center">{t("createWebsitePage.faqTitle")}</h2>
                    <div className="space-y-4">
                        {(t("createWebsitePage.faqs") || []).map((faq, index) => (
                            <div 
                                key={index} 
            ...
            <section className="py-20 px-6 md:px-16 lg:px-24 xl:px-32">
                <div className="max-w-3xl mx-auto text-center">
                    <h2 className="text-3xl font-bold text-slate-900 mb-4">{t("createWebsitePage.ctaTitle")}</h2>
                    <p className="text-slate-600 mb-8">
                        {t("createWebsitePage.ctaDesc")}
                    </p>
                    <Link href="/contact" className="bg-black hover:bg-gray-800 transition text-white rounded-md px-8 h-12 font-medium flex items-center">
                        {t("createWebsitePage.ctaCta1")}
                    </Link>
                </div>
            </section>
        </div>
