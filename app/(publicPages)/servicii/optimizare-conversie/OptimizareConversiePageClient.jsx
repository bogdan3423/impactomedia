...
export default function OptimizareConversiePageClient() {
        ...
        <div className="min-h-screen">
            ...
            <section className="pt-32 pb-20 px-6 md:px-16 lg:px-24 xl:px-32 bg-gradient-to-b from-slate-50 to-white">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6">
                        {t("optimizarePage.title")}
                    </h1>
                    <p className="text-xl text-slate-600 mb-8 max-w-2xl mx-auto">
                        {t("optimizarePage.subtitle")}
                    </p>
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <Link href="/#servicii" className="border border-black transition text-slate-600 rounded-md px-8 h-12 font-medium flex items-center">
                            {t("optimizarePage.seeAllServices")}
                        </Link>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 px-6 md:px-16 lg:px-24 xl:px-32 bg-slate-50">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl font-bold text-slate-900 mb-10 text-center">{t("optimizarePage.whatsIncluded")}</h2>
                    <div className="grid md:grid-cols-2 gap-4">
                        {(t("optimizarePage.includes") || []).map((item, index) => (
            ...
            <section className="py-16 px-6 md:px-16 lg:px-24 xl:px-32">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl font-bold text-slate-900 mb-10 text-center">{t("optimizarePage.processTitle")}</h2>
                    <div className="space-y-6">
                        {(t("optimizarePage.process") || []).map((item, index) => (
            ...
            <section className="py-16 px-6 md:px-16 lg:px-24 xl:px-32 bg-slate-900 text-white">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl font-bold mb-10 text-center">{t("optimizarePage.benefitsTitle")}</h2>
                    <div className="grid md:grid-cols-2 gap-6">
                        {(t("optimizarePage.benefits") || []).map((benefit, index) => (
            ...
            <section className="py-16 px-6 md:px-16 lg:px-24 xl:px-32">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl font-bold text-slate-900 mb-10 text-center">{t("optimizarePage.targetTitle")}</h2>
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {(t("optimizarePage.targetAudience") || []).map((audience, index) => (
            ...
            <section className="py-16 px-6 md:px-16 lg:px-24 xl:px-32 bg-slate-50">
                <div className="max-w-3xl mx-auto">
                    <h2 className="text-3xl font-bold text-slate-900 mb-10 text-center">{t("optimizarePage.faqTitle")}</h2>
                    <div className="space-y-4">
                        {(t("optimizarePage.faqs") || []).map((faq, index) => (
                            <div 
                                key={index} 
            ...
            <section className="py-20 px-6 md:px-16 lg:px-24 xl:px-32">
                <div className="max-w-3xl mx-auto text-center">
                    <h2 className="text-3xl font-bold text-slate-900 mb-4">{t("optimizarePage.ctaTitle")}</h2>
                    <p className="text-slate-600 mb-8">
                        {t("optimizarePage.ctaDesc")}
                    </p>
                    <Link href="/contact" className="bg-black hover:bg-gray-800 transition text-white rounded-md px-8 h-12 font-medium flex items-center">
                        {t("optimizarePage.ctaCta1")}
                    </Link>
                </div>
            </section>
        </div>
